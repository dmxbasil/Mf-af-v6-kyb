...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            ...
            [ InlineKeyboardButton("• ɢᴏ ʙᴀᴄᴋ •", callback_data="lazyhome") ]
            ]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [
            [ InlineKeyboardButton("• ɢᴏ ʙᴀᴄᴋ •", callback_data="getlazythumbnail") ]
            ]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [
            [ InlineKeyboardButton("• ɢᴏ ʙᴀᴄᴋ •", callback_data="getlazylink") ]
            ]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.DNT_TEXT.format(query.from_user.mention),
